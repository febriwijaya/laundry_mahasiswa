      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h3 class="h3 mb-0 text-gray-800">Ubah Karyawan</h3>
          </div>
                ...
                <div class="col-md-12">
                  <form class="mb-4 mt-2" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" value="<?= $saran["nama"]; ?>" class="form-control" id="nama" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="alamat" value="<?= $saran["alamat"]; ?>" class="form-control" id="alamat" required>
                    </div>
                    <div class="form-group">
                      <label for="email">email</label>
                      <input type="text" name="email" value="<?= $saran["email"]; ?>" class="form-control" id="telepon" required>
                    </div>
                    <div class="form-group">
                      <label for="hp">No.hp</label>
                      <input type="text" name="hp" value="<?= $saran["hp"]; ?>" class="form-control" id="hp" required>
                    </div>
                    <div class="form-group">
                      <label for="gambar">Gambar</label> <br>
                      <img src="image/<?= $saran['gambar']; ?>" width="50" height="50">
                      <input type="file" name="gambar" id="gambar" required>
                    </div>
                    <div class="form-group">
                      <label for="komentar">Komentar dan Saran</label>
                      <textarea name="komentar" value="<?= $saran["komentar"]; ?>" class="form-control" id="komentar" required></textarea>
                    </div>
                    <button type="submit" name="submit" class="btn btn-primary">UBAH</button>
                    <a href="saran.php" class="btn btn-danger">Batal</a>
                  </form>
                </div>
              </div>
            </div>
