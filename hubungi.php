...
<body>
  ...
  <!-- ingin tahu lebih soal laundry UMI -->
  <div class="container mt-5 batas">
    <div class="row mb-5">
      <div class="col-md-6">
        <h4 class="roboto" style="font-weight:700">INGIN TAHU LEBIH SOAL UMI LAUNDRY?</h4>
        <p class="roboto text-justify">Masih ada pertanyaan yang belum terjawab? Anda bisa menghubungi kami dengan
          mengisi form
          berikut atau bisa langsung menghubungi kami melalui Whatsapp.
          Anda juga bisa melihat lokasi-lokasi outlet kami di sini.

          Tim Customer Service kami akan siap memandu Anda!</p>
      </div>
      <div class="col-md-6">
        <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <input type="text" class="form-control" name="nama" placeholder="Tulis Nama" required>
          </div>
          <div class="form-group">
            <input type="email" class="form-control" name="email" placeholder="Tulis Email" required>
          </div>
          <div class="form-group">
            <input type="text" class="form-control" name="nohp" placeholder="Tulis nomor handphone" required>
          </div>
          <div class="form-group">
            <textarea name="komentar" style="height:80px;" class="form-control" placeholder="Tulis pesan...." required></textarea>
          </div>
  ...
  <!-- akhir ingin tahu lebih soal laundry UMI -->
