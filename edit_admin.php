...
if (isset($_POST["submit"])) {
  ...
  if (ubah_admin($_POST) > 0) {
    echo "
        ...
        document.location.href = 'manajemen_admin.php';
        </script>";
  } else {
    echo "
        <script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h3 class="h3 mb-0 text-gray-800">Tambah Administrator</h3>
          </div>
          <div class="card shadow mb-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <form class="mb-4 mt-2" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="telepon" class="form-control" value="<?= $mhs["telepon"]; ?>" id="telepon">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="username" class="form-control" value="<?= $mhs["username"]; ?>" id="username">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="manajemen_admin.php" class="btn btn-danger">Batal</a>
                  </form>
                </div>
              </div>
            </div>
