                ...
                <div class="col-md-12">
                  <form class="mb-4 mt-2" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" value="<?= $kry["nama"]; ?>" class="form-control" id="nama" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="alamat" value="<?= $kry["alamat"]; ?>" class="form-control" id="alamat" required>
                    </div>
                    <div class="form-group">
                      <label for="telepon">Telepon</label>
                      <input type="text" name="telepon" value="<?= $kry["telepon"]; ?>" class="form-control" id="telepon" required>
                    </div>
                    <div class="form-group">
                      <label for="gambar">Gambar</label> <br>
                      <img src="image/<?= $kry['gambar']; ?>" width="50" height="50">
